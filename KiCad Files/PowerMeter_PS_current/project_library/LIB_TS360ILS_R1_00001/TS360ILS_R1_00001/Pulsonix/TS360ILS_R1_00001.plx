...
(library Library_1
	...
	(patternDef "SOP400P650X145-4N" (originalName "SOP400P650X145-4N")
		...
		(layerContents (layerNumRef 28)
			(line (pt -2.2 -1.5) (pt 1.8 2.5) (width 0.025))
		)
		(layerContents (layerNumRef 18)
	...
	(compDef "TS360ILS_R1_00001" (originalName "TS360ILS_R1_00001") (compHeader (numPins 4) (numParts 1) (refDesPrefix IC)
		...
		(attr "<Hyperlink>" "https://www.mouser.co.id/datasheet/2/1057/TS360ILS-1877238.pdf")
		(attr "<Component Height>" "1.45")
		(attr "<STEP Filename>" "TS360ILS_R1_00001.stp")
