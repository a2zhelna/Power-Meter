...
(library Library_1
	...
	(patternDef "SOP250P700X290-4N" (originalName "SOP250P700X290-4N")
		...
		(layerContents (layerNumRef 28)
			(line (pt -1.925 2.362) (pt 1.925 2.362) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 1.925 2.362) (pt 1.925 -2.362) (width 0.025))
		)
		...
		(layerContents (layerNumRef 28)
			(line (pt -1.925 -0.138) (pt 0.575 2.362) (width 0.025))
		)
		(layerContents (layerNumRef 18)
	...
	(compDef "KMB28STR" (originalName "KMB28STR") (compHeader (numPins 4) (numParts 1) (refDesPrefix BR)
		...
		(compPin "4" (pinName "~_2") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "3" (pinName "~_1") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attr "<Hyperlink>" "http://www.smc-diodes.com/propdf/KMB22S%20THRU%20KMB225S%20N1952%20REV.A.pdf")
		(attr "<Component Height>" "2.9")
		(attr "<STEP Filename>" "KMB28STR.stp")
